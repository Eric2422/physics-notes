...
\begin{equation*}
    \begin{aligned}
        I V
        &= \left( \unit{\joule \per \coulomb} \right) \left( \unit{\coulomb \per \second} \right)
...
\end{equation}
Of course,
we can apply Ohm's law: \eqPgRef{eq:ohms-law} to replace either \(I\) or \(V\).

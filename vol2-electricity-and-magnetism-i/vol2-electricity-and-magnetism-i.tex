...
The magnitude of the electric force around a charged particle or sphere can be given by \textbf{Coulomb's law},
which states
...
Let 
\begin{itemize}
    \item \(\vecb{A}\) be the area vector of the spherical surface and \(A\) be its magnitude,
...
The relation between the voltage \(V\) and current \(I\) is given by \textbf{Ohm's law}:
\begin{equation} \label{eq:ohms-law}
    V = I R
\end{equation}
where \(R\) is the \textbf{resistance}, which has SI units of ohms (\unit{\ohm}).
...
\begin{equation}
    ...
    \end{aligned}
\end{equation}
We can apply Ohm's law: \pgRef{eq:ohms-law} to replace either current or voltage.

...
\textbf{Electric charge}~(symbol: \(q\) or sometimes \(Q\))
is measured in coulombs~(\unit{\coulomb}).
...
\textbf{Electric fields}~(symbol: \(E\)) are closely related to electric forces
...
\(R\) be the radius of the imaginary Gaussian surface,
and \(\rho(r)\) be the charge density as a function of radius.

The charge inside the sphere is
\begin{equation}
    q = \int_{0}^{\mathrm{R}} 4 \pi r^2 \rho(r) \odif{r}.
\end{equation}
Similarly to the above derivation of Coulomb's law,
the electric flux \(\Phi_E\) is \(4 E \pi R^2\),
so we find
\begin{equation}
    \begin{aligned}
        4 E \pi R^2
        &= \frac{
            \int_{0}^{\mathrm{R}} 4 \pi r^2 \rho(r) \odif{r}
        }{\epsilon_0} \\
        E
        &= \frac{
            \int_{0}^{\mathrm{R}} r^2 \rho(r) \odif{r}
        }{R^2 \epsilon_0} \\
    \end{aligned}
\end{equation}
In the case where \(\rho(r)\) is a constant charge density~\(\rho\),
we find
\begin{equation}
    \begin{aligned}
        E
        &= \frac{
            \int_{0}^{\mathrm{R}} r^2 \rho \odif{r}
        }{R^2 \epsilon_0} \\
        &= \frac{
            R^3 \rho
        }{3 R^2 \epsilon_0} \\

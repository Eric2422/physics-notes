...
\(R\) is the radius of the imaginary Gaussian surface,
and \(\rho(r)\) be the charge density as a function of radius.

The charge inside the sphere is
\begin{equation}
    q = \int_0^{\mathrm{R}} 4 \pi r^2 \rho(r) \odif{r}.
\end{equation}
...
\begin{equation}
    \begin{aligned}
        4 E \pi R^2
        &= \frac{
            \int_0^{\mathrm{R}} 4 \pi r^2 \rho(r) \odif{r}
        }{\epsilon_0} \\
        E
        &= \frac{
            \int_0^{\mathrm{R}} r^2 \rho(r) \odif{r}
        }{R^2 \epsilon_0} \\
    \end{aligned}
\end{equation}

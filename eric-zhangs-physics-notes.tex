...
the "Electricity and Magnetism" section has relative paucity of content
compared to the "Mechanics" and "Waves and Oscillations" section.

These notes are \emph{not} a replacement for an actual physics textbook
and were \emph{never} meant to do so.

...
terminal velocity is achieved at
...
We start with Newton's second law of motion [\pgRef{eq:newtons-2nd-law}] and \pgRef{eq:linear-drag},
finding that
\begin{subequations}
...
Let
\begin{itemize}
    \item \(L_\mathrm{A}\) and \(L_\mathrm{B}\) be the angular momenta at points A and B, respectively.
    \item \(v_\mathrm{A}\) and \(v_\mathrm{B}\) be the velocities at points A and B, respectively.
    \item
        \(r_\mathrm{A}\) and \(r_\mathrm{B}\) be the distances from the star to A and B, respectively.

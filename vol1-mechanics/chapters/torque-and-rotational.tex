...
\textbf{Moment of inertia} or \textbf{rotational inertia}~(symbol: \(I\)) is
...
Imagine a cylindrical rod of uniform density~\(\lambda\),
length~\(\ell\), and mass~\(M\)
...
\textbf{Torque}~(symbol: \(\vecb{\tau}\)) is the rotational analogue
to linear force

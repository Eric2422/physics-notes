...
\mathTopics{\pgRef{ch:complex-and-imaginary-numbers}}
...
General solutions:
\begin{itemize}
    \item \(x(t) = A\cos\ab( \omega_0 t ) + B\sin\ab( \omega_0 t )\)
    \item \(x(t) = A\cos\ab( \omega_0 t + \phi )\)
...
\begin{equation}
    \ab\| z \| = \sqrt{\Re(z)^2 + \Im(z)^2} = \sqrt{z z^*}
\end{equation}

...
We plug a guess of the form \(\boldsymbol{\hat{x}}(t) = A e^{i \phi} e^{i \beta t}\) into the equation
and get
\begin{equation}
    \boldsymbol{\hat{x}}(t)
    = A
...
depending on the ratio between the damping coefficient \(\gamma\) and the natural frequency \(\omega_0\).
